...
public class ConstantPressureLiquidNode implements LiquidNode, Simulator,WillieObject, ReportWriter,RequiresTimeManager,RequiresPostStepProcessing{
	...
	public ConstantPressureLiquidNode(String name){
		this.name = name;
